      ...
      <div className="w-full max-w-lg p-6 m-auto mx-auto bg-white rounded-lg shadow-md ">
        ...
        <div className="flex items-center mt-6 -mx-2">
          <button
            onClick={googleSign}
            type="button"
            className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-yellow-500 rounded-lg "
          >
